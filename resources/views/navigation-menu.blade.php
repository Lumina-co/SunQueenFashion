        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    {{-- pour afficher les pages admin en menu l'* permet de souligner tout ce qui commence de schedule --}}
                    <x-nav-link href="{{ route('schedule.index') }}" :active="request()->routeIs('schedule.*')">
                        Horaires
                    </x-nav-link>
                    <x-nav-link href="{{ route('season.index') }}" :active="request()->routeIs('season.*')">
                        Saisons
                    </x-nav-link>
