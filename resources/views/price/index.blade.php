                    ...
                    <tbody>
                        ...
                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 ">
                            ...
                            <td class="px-6 py-4 flex items-center gap-2  justify-end ">
                                ...
                                <a href="{{ route('price.edit', $price) }}" class="rounded-2xl text-sm text-black py-2 px-3 hover:bg-gray-200 hover:text-black-800 shadow-xl cursor-pointer bg-yellow-300 transition-all duration-200">modifier</a>
