<x-app-layout>
    <x-slot name="header">
        ...
        <h2 class=" bg-gray-800 text-4xl p-4 font-bold text-white leading-tight text-center">
             Horaires
        </h2>
    ...
    <div class="flex justify-center items-center ">
        <div class="bg-gray-500 border-8 w-3/4  ">
            ...
            <div class="relative overflow-x-auto mt-12 max-w-7xl mx-auto px-8 pb-12 shadow-xl">
                <table class="w-full text-sm text-left text-black dark:text-gray-400 ">
                    <thead class="text-xs text-white  bg uppercase bg-topaz border-2">
                        <tr>
                    ...
                    <tbody>
                        ...
                        <tr class="bg-white border-b  dark:bg-gray-800 dark:border-gray-700">
                            ...
                            <td class="px-6 py-4 flex items-center gap-2">
                                <a href="{{ route('schedule.edit', $schedule) }}" class="rounded-2xl text-sm text-black py-2 px-3 hover:bg-gray-200 hover:text-black-800 shadow-xl cursor-pointer bg-yellow-300 transition-all duration-200">modifier</a>
