                ...
                <div class="relative overflow-x-auto mt-12 max-w-7xl mx-auto px-8 pb-36">
                    <table class="w-full text-sm text-left text-black dark:text-gray-400">
                        ...
                        <tbody>
                            ...
                            <td class="px-6 py-4 border-2">{{ $holidays->date_début }}</td>
                            <td class="px-6 py-4 border-2"> {{ $holidays->date_fin}}</td>
                            <td class="px-6 py-4 border-2">{{ $holidays->description }}</td>

                            </td>
                            <td class="px-6 py-4 flex items-center gap-2">

                                <a href="{{ route('holidays.edit', $holidays) }}" class="rounded-2xl bg-yellow-300 text-sm text-black py-2 px-3 hover:bg-gray-200 hover:text-black-800 shadow-xl cursor-pointer transition-all duration-200">modifier</a>
