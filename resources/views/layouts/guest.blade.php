...
<body class="w-full">
    ...
    <header>
        {{-- desktop menu --}}
        <nav class="hidden lg:flex justify-between bg-black1 shadow-lg" id="haut-de-page">
            <div class="ml-8">
                <x-application-logo />
            </div>
        ...
        {{-- mobile menu --}}
        <nav class="leading-10 w-full block lg:hidden bg-black1 ">
            ...
            <button id="button" class="m-4 ">
                <svg id="open" class="hidden bg-white" xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 256 256">
                    <path fill="currentColor" d="M222 128a6 6 0 0 1-6 6H40a6 6 0 0 1 0-12h176a6 6 0 0 1 6 6ZM40 70h176a6 6 0 0 0 0-12H40a6 6 0 0 0 0 12Zm176 116H40a6 6 0 0 0 0 12h176a6 6 0 0 0 0-12Z" /></svg>
                <svg id="close" class="bg-white" xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 15 15">
                    <path fill="currentColor" fill-rule="evenodd" d="M12.854 2.854a.5.5 0 0 0-.708-.708L7.5 6.793L2.854 2.146a.5.5 0 1 0-.708.708L6.793 7.5l-4.647 4.646a.5.5 0 0 0 .708.708L7.5 8.207l4.646 4.647a.5.5 0 0 0 .708-.708L8.207 7.5l4.647-4.646Z" clip-rule="evenodd" /></svg>
            </button>


            <div id="menu" class="flex-col flex gap-8 p-8 items-center  ">
                <a href="#uv" class="group flex items-center text-white hover:text-red1 transition-colors duration-300">
                    Solarium
                </a>
